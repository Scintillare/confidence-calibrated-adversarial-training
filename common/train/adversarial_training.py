...
class AdversarialTraining(NormalTraining):
    ...
    def __init__(self, model, trainset, testset, optimizer, scheduler, attack, objective, fraction=0.5, augmentation=None, writer=common.summary.SummaryWriter(), cuda=False):
        """
        Constructor.
        ...
        super(AdversarialTraining, self).__init__(model, trainset, testset, optimizer, scheduler, augmentation, writer, cuda)
